...
{
    public class InjectionEfficiencyLimitsPresenter
    {
        KronosTestAppMainForm kronostestappMainForm { get; set; }
        InjectionEfficiencyTestLimitsData injectionEfficiencyTestLimitsData { get; set; }
        ...
        XDocument xmlDoc;
        bool DBExists = false;      
        public InjectionEfficiencyLimitsPresenter(InjectionEfficiencyTestLimitsData injectionEfficiencyTestLimitsData, KronosTestAppMainForm kronostestappMainForm)
        {
            try
            {
                this.injectionEfficiencyTestLimitsData = injectionEfficiencyTestLimitsData;
                injectionEfficiencyTestLimitsDataList = new List<InjectionEfficiencyTestLimitsData>();
                kronostestappMainForm.injectionEfficiencyTestLimitsPresenter = this;
